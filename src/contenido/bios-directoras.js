...
export const directors = [
  {
    ...
    intro: [
      ...
      'Su trayectoria está marcada por una vocación doble: la atención directa de pacientes y la formación de otros psiquiatras. Durante casi tres décadas trabajó en el Instituto de Investigaciones Médicas Dr. Alfredo Lanari, hospital universitario de la UBA, donde llegó a dirigir el Servicio de Salud Mental. Fue también docente en la Facultad de Medicina de la UBA, coordinadora docente en la Universidad de Belgrano e invitada a dar clases en otras instituciones académicas.',
    ...
    body: [
      'Su vínculo con el Lanari atraviesa casi toda su carrera. Fue Subjefa del Servicio de Salud Mental a partir de 1996 y lo condujo como Jefa hasta 2012. Durante ese período fue también miembro del equipo de Trasplante Renal y asesora del Servicio de Endocrinología Experimental — una experiencia que amplió su perspectiva hacia la psiquiatría de interconsulta y el trabajo en contextos de alta complejidad médica general.',
      'Entre 2006 y 2012 supervisó y orientó clínicamente a los profesionales del Curso de Especialista en Psiquiatría de la UBA — formando a quienes hoy ejercen la especialidad. Fue docente de Psiquiatría, Psicosemiología y Salud Mental en la carrera de Medicina de la UBA, encargada docente en el Hospital Houssay (Departamento de Salud Mental, Provincia de Buenos Aires) hasta 2024 y coordinadora docente en la Universidad de Belgrano. Fue invitada a dar clases en la Universidad Nacional de La Plata, la UCES, el Instituto de Psicocardiología de Buenos Aires y el Instituto de Psicoanálisis Contemporáneo.',
